  ...
  var e = {
      ...
      7528: function (e, t, n) {
        ...
        t.createPopover = function (e, t) {
          ...
          var n,
            ...
            })(m.buttonColor || d.buttonColor)
          ;(m.container || document.body).append(g),
            _.append(y),
            g.append(j),
            g.append(E),
            j.append(O)
          ...
          m.tooltip &&
            ...
            g.append(p)),
            m.notificationDays &&
              (m.enableSandbox || i.canBuildNotificationDot(e)) &&
              ((v = i.buildNotificationDot()), j.append(v)),
            (y.onload = function () {
          ...
          var C = function () {
              a(_) ||
                ...
                v &&
                  ...
                  m.notificationDays &&
                    !m.enableSandbox &&
                    i.saveNotificationDotHideUntilTime(e, m.notificationDays),
                  setTimeout(function () {
                    r.unmountElement(v)
                  }, 250)),
                setTimeout(function () {
          ...
          r.setAutoClose(h, m.autoClose, I)
          var S = function () {
            a(_) ? I() : C()
          }
          return (
            (j.onclick = S),
            (E.onclick = I),
            m.open && !a(_) && r.handleCustomOpen(C, m.open, m.openValue),
            {
              open: C,
              close: I,
              toggle: S,
      ...
      9630: function (e, t, n) {
        ...
        t.createPopup = function (e, t) {
          ...
          h.append(p), b.append(y), b.append(h)
          var g = l.container || document.body
          p.onload = function () {
            ;(h.style.opacity = "1"),
              setTimeout(function () {
                y.style.display = "none"
              }, 250),
              r.addCustomKeyboardListener(O)
          }
          var _ = function () {
              a(b) ||
                (g.append(b),
          ...
          h.append(
            ...
            r.setAutoClose(v, l.autoClose, O)
          var w = function () {
            r.unmountElement(b)
          }
          return (
            l.open && !a(b) && r.handleCustomOpen(_, l.open, l.openValue),
            {
              open: _,
              close: O,
              toggle: function () {
      ...
      382: function (e, t, n) {
        ...
        t.createSidetab = function (e, t) {
          ...
          var n,
            ...
            })(m.buttonText || i.buttonText),
            E =
              ((l = m.customIcon),
              (f = m.buttonColor || i.buttonColor),
              (p = r.getTextColor(f)),
          ...
          var C = function () {
            ...
            I = function () {
              var e
              a(_) &&
                (null === (e = m.onClose) || void 0 === e || e.call(m),
          ...
          var _ = function () {
            ...
            O = function () {
              a(b) &&
                ...
                (document.body.style.overflow = m),
                setTimeout(function () {
                  b.parentNode.removeChild(b), (y.style.display = "block")
                }, 500))
            }
          return (
            r.setAutoClose(v, l.autoClose, O),
          ...
          a.length > 0 && o.includeCss(t),
            Array.from(a).forEach(function (t, o) {
              if (n || "true" !== t.dataset.tfLoaded) {
                ...
                if (!a)
                  throw new Error("Invalid " + e + "=" + a + " for embed #" + o)
                ...
                o(
                  o(
                    {},
                    {
                      ...
                      "force-touch": y ? "true" : void 0,
                      "add-placeholder-ws":
                        "widget" === e && h ? "true" : void 0,
                    }
                  ),
                  _
                ),
      ...
      1553: function (e, t, n) {
        ...
        t.createIframe = function (e, t, n) {
          ...
          return (
            (y.src = b),
            (y.dataset.testid = "iframe"),
            (y.style.border = "0px"),
            Object.keys(l).forEach(function (e) {
              y.setAttribute(e, l[e])
            }),
            y.addEventListener("load", u.triggerIframeRedraw, { once: !0 }),
            window.addEventListener("message", a.getFormReadyHandler(d, f)),
            window.addEventListener(
              "message",
              a.getFormQuestionChangedHandler(d, p)
            ),
            window.addEventListener("message", a.getFormSubmitHandler(d, v)),
            "widget" !== t &&
              window.addEventListener(
                "message",
